...
- (void)viewDidLoad {
    ...
    self.initialLanguageCode = [[NSUserDefaults standardUserDefaults] stringForKey:@"MxLanguage"] ?: @"en";
    ...
    self.title = [MxLocalization localizedStringForKey:@"LANGUAGE_SECTION_HEADER"] ?: @"Language";
...
- (void)applyTapped {
    ...
    NSString *title = [MxLocalization localizedStringForKey:@"APPLY"] ?: @"Apply";
    NSString *message = [MxLocalization localizedStringForKey:@"APPLY_CHANGES"] ?: @"To apply the language, you need to restart the app.";
    ...
    UIAlertAction *restartAction = [UIAlertAction actionWithTitle:@"Restart"
        ...
        [[NSUserDefaults standardUserDefaults] setObject:self.selectedLanguageCode forKey:@"MxLanguage"];
    ...
    UIAlertAction *cancelAction = [UIAlertAction actionWithTitle:[MxLocalization localizedStringForKey:@"CANCEL"] ?: @"Cancel"
