    ...
    indirect enum Message: TypeConstructorDescription {
        ...
        public func serialize(_ buffer: Buffer, _ boxed: Swift.Bool) {
            ...
            case .message(let _data):
                if boxed {
                    // Mx: 12.2 numbers this one differently. The field layout needs
                    // no branch — every field 12.9 added sits behind a flag bit, and
                    // the flags word being echoed back is the one the 12.2 server
                    // sent, so those bits are clear and the serializer skips them.
                    buffer.appendInt32(MxApiCompat.constructorId(current: 1979759059,
                                                                legacy: 1979759059,
                                                                l122: MxApiCompat.l122Message))
                }
                serializeInt32(_data.flags, buffer: buffer, boxed: false)
        ...
        public static func parse_message(_ reader: BufferReader) -> Message? {
            ...
            var _36: Api.RichMessage?
            if Int(_2 ?? 0) & Int(1 << 13) != 0 {
                if let signature = reader.readInt32() {
                    _36 = Api.parse(reader, signature: signature) as? Api.RichMessage
                }
            }
            let _c1 = _1 != nil
            let _c2 = _2 != nil
            ...
            let _c36 = (Int(_2 ?? 0) & Int(1 << 13) == 0) || _36 != nil
