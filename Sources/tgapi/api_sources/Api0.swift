...
fileprivate let parsers: [Int32 : (BufferReader) -> Any?] = {
    ...
    // ── Mx: dual-layer compatibility ─────────────────────────────────────
    // See MxApiCompat.swift. Three definitions changed between 12.8 and 12.9 and
    // 74 between 12.2 and 12.9; register every id, and have whichever one arrives
    // record the layer the host is speaking so the serializer can answer in it.
    dict[MxApiCompat.legacyUser] = { return Api.User.parse_user_legacyLayer($0) }
    dict[MxApiCompat.legacyChannel] = { return Api.Chat.parse_channel_legacyLayer($0) }
    dict[MxApiCompat.legacyBotCommand] = { return Api.BotCommand.parse_botCommand_legacyLayer($0) }
    dict[-1313289085] = { MxApiCompat.note(.l129); return Api.User.parse_user($0) }
    dict[-727763770] = { MxApiCompat.note(.l129); return Api.Chat.parse_channel($0) }
    dict[-1739401518] = { MxApiCompat.note(.l129); return Api.BotCommand.parse_botCommand($0) }

    // The 71 further definitions that 12.2 (iMe) numbers differently. Generated
    // together with their parsers — see MxApiLayer122.swift.
    dict[-885426663] = { return Api.ChannelParticipant.parse_channelParticipant_l122($0) }
    dict[1844969806] = { return Api.ChannelParticipant.parse_channelParticipantBanned_l122($0) }
    dict[1331723247] = { return Api.ChannelParticipant.parse_channelParticipantSelf_l122($0) }
    dict[-455036259] = { return Api.ChatFull.parse_channelFull_l122($0) }
    dict[-1070776313] = { return Api.ChatParticipant.parse_chatParticipant_l122($0) }
    dict[-1600962725] = { return Api.ChatParticipant.parse_chatParticipantAdmin_l122($0) }
    dict[-462696732] = { return Api.ChatParticipant.parse_chatParticipantCreator_l122($0) }
    dict[-849058964] = { return Api.ConnectedBot.parse_connectedBot_l122($0) }
    dict[-712374074] = { return Api.Dialog.parse_dialog_l122($0) }
    dict[-1763006997] = { return Api.DraftMessage.parse_draftMessage_l122($0) }
    dict[-838922550] = { return Api.ForumTopic.parse_forumTopic_l122($0) }
    dict[-1279654347] = { return Api.InputMedia.parse_inputMediaPhoto_l122($0) }
    dict[261416433] = { return Api.InputMedia.parse_inputMediaPoll_l122($0) }
    dict[505969924] = { return Api.InputMedia.parse_inputMediaUploadedPhoto_l122($0) }
    dict[-2036351472] = { return Api.InputReplyTo.parse_inputReplyToMessage_l122($0) }
    dict[-1682807955] = { return Api.InputStorePaymentPurpose.parse_inputStorePaymentAuthCode_l122($0) }
    dict[-916050683] = { return Api.KeyboardButton.parse_inputKeyboardButtonRequestPeer_l122($0) }
    dict[-802258988] = { return Api.KeyboardButton.parse_inputKeyboardButtonUrlAuth_l122($0) }
    dict[-376962181] = { return Api.KeyboardButton.parse_inputKeyboardButtonUserProfile_l122($0) }
    dict[-1560655744] = { return Api.KeyboardButton.parse_keyboardButton_l122($0) }
    dict[-1344716869] = { return Api.KeyboardButton.parse_keyboardButtonBuy_l122($0) }
    dict[901503851] = { return Api.KeyboardButton.parse_keyboardButtonCallback_l122($0) }
    dict[1976723854] = { return Api.KeyboardButton.parse_keyboardButtonCopy_l122($0) }
    dict[1358175439] = { return Api.KeyboardButton.parse_keyboardButtonGame_l122($0) }
    dict[-59151553] = { return Api.KeyboardButton.parse_keyboardButtonRequestGeoLocation_l122($0) }
    dict[1406648280] = { return Api.KeyboardButton.parse_keyboardButtonRequestPeer_l122($0) }
    dict[-1318425559] = { return Api.KeyboardButton.parse_keyboardButtonRequestPhone_l122($0) }
    dict[-1144565411] = { return Api.KeyboardButton.parse_keyboardButtonRequestPoll_l122($0) }
    dict[-1598009252] = { return Api.KeyboardButton.parse_keyboardButtonSimpleWebView_l122($0) }
    dict[-1816527947] = { return Api.KeyboardButton.parse_keyboardButtonSwitchInline_l122($0) }
    dict[629866245] = { return Api.KeyboardButton.parse_keyboardButtonUrl_l122($0) }
    dict[280464681] = { return Api.KeyboardButton.parse_keyboardButtonUrlAuth_l122($0) }
    dict[814112961] = { return Api.KeyboardButton.parse_keyboardButtonUserProfile_l122($0) }
    dict[326529584] = { return Api.KeyboardButton.parse_keyboardButtonWebView_l122($0) }
    dict[-1188071729] = { return Api.Message.parse_message_l122($0) }
    dict[-614898352] = { return Api.MessageAction.parse_messageActionStarGift_l122($0) }
    dict[-1787656893] = { return Api.MessageAction.parse_messageActionStarGiftUnique_l122($0) }
    dict[1065280907] = { return Api.MessageMedia.parse_messageMediaDice_l122($0) }
    dict[1766936791] = { return Api.MessageMedia.parse_messageMediaPhoto_l122($0) }
    dict[1272375192] = { return Api.MessageMedia.parse_messageMediaPoll_l122($0) }
    dict[1763137035] = { return Api.MessageReplyHeader.parse_messageReplyHeader_l122($0) }
    dict[-1702174239] = { return Api.PageBlock.parse_pageBlockOrderedList_l122($0) }
    dict[635466748] = { return Api.PageListItem.parse_pageListItemBlocks_l122($0) }
    dict[-1188055347] = { return Api.PageListItem.parse_pageListItemText_l122($0) }
    dict[-1730311882] = { return Api.PageListOrderedItem.parse_pageListOrderedItemBlocks_l122($0) }
    dict[1577484359] = { return Api.PageListOrderedItem.parse_pageListOrderedItemText_l122($0) }
    dict[1484026161] = { return Api.Poll.parse_poll_l122($0) }
    dict[-15277366] = { return Api.PollAnswer.parse_pollAnswer_l122($0) }
    dict[997055186] = { return Api.PollAnswerVoters.parse_pollAnswerVoters_l122($0) }
    dict[2061444128] = { return Api.PollResults.parse_pollResults_l122($0) }
    dict[1457736048] = { return Api.ReactionsNotifySettings.parse_reactionsNotifySettings_l122($0) }
    dict[-1987861422] = { return Api.SavedStarGift.parse_savedStarGift_l122($0) }
    dict[463097215] = { return Api.StarGift.parse_starGift_l122($0) }
    dict[-1329630181] = { return Api.StarGift.parse_starGiftUnique_l122($0) }
    dict[-650279524] = { return Api.StarGiftAttribute.parse_starGiftAttributeBackdrop_l122($0) }
    dict[970559507] = { return Api.StarGiftAttribute.parse_starGiftAttributeModel_l122($0) }
    dict[330104601] = { return Api.StarGiftAttribute.parse_starGiftAttributePattern_l122($0) }
    dict[-1419714037] = { return Api.StarGiftAuctionAcquiredGift.parse_starGiftAuctionAcquiredGift_l122($0) }
    dict[1571835723] = { return Api.StarGiftAuctionState.parse_starGiftAuctionState_l122($0) }
    dict[2107014202] = { return Api.StarGiftAuctionState.parse_starGiftAuctionStateFinished_l122($0) }
    dict[-302947087] = { return Api.StoryItem.parse_storyItem_l122($0) }
    dict[299870598] = { return Api.Update.parse_updateBotChatInviteRequester_l122($0) }
    dict[-1398708869] = { return Api.Update.parse_updateMessagePoll_l122($0) }
    dict[619974263] = { return Api.Update.parse_updateMessagePollVote_l122($0) }
    dict[-1886646706] = { return Api.UrlAuthResult.parse_urlAuthResultAccepted_l122($0) }
    dict[-1831650802] = { return Api.UrlAuthResult.parse_urlAuthResultRequest_l122($0) }
    dict[-1607745218] = { return Api.UserFull.parse_userFull_l122($0) }
    dict[55150251] = { return Api.WebPageAttribute.parse_webPageAttributeStarGiftAuction_l122($0) }
    dict[-527082948] = { return Api.auth.SentCode.parse_sentCodePaymentRequired_l122($0) }
    dict[-1745778728] = { return Api.payments.StarGiftActiveAuctions.parse_starGiftActiveAuctions_l122($0) }
    dict[244900980] = { return Api.payments.StarGiftAuctionState.parse_starGiftAuctionState_l122($0) }
    return dict
}()
